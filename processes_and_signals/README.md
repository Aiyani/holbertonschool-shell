...
| `10-process_and_pid_file` | Prints some messages according to sended signals |
| `11-manage_my_process` | Init script that manages `manage_my_process` with `start`, `stop` and `restart` instructions |
